                                ...
                                <div key={index} className="flex-shrink-0 flex items-center justify-center ">
                                    {logo.type === 'search' && (
                                        <div className="flex items-center space-x-2 bg-gray-100 px-4 py-2 rounded-lg">
                                            <span className="text-gray-700 font-medium text-sm">{logo.name}</span>
                                    ...
                                    {logo.type === 'text' && (
                                        <div className="text-gray-700 font-bold text-lg">
                                            <span className="relative">
                                                HU
                                                <span className="absolute -top-1 -right-1 w-2 h-2 bg-gray-400 rounded-full opacity-60"></span>
                                            </span>
                                    ...
                                    {logo.type === 'geometric' && (
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <span className="text-gray-700 font-bold text-lg">{logo.name}</span>
                                        </div>
                                    )}
                                    {logo.type === 'diamond' && (
                                        <div className="flex items-center space-x-2">
                                            <div className="relative w-6 h-6">
                                                ...
                                                <div className="absolute inset-0 bg-gray-600 transform rotate-45 scale-50"></div>
                                            </div>
                                            <span className="text-gray-700 font-bold text-lg">{logo.name}</span>
                                        </div>
                                    )}
                                    {logo.type === 'arrow' && (
                                        <div className="text-center">
                                            <div className="text-gray-700 font-bold text-lg flex items-center justify-center">
                                                webgenius
                                                <span className="ml-1 text-blue-500">↑</span>
                                            </div>
                                            <div className="text-gray-500 text-xs mt-1">{logo.subtitle}</div>
                                        </div>
                                    )}
                                </div>
                            ))}
