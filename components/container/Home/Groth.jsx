    ...
    <div className="min-h-screen bg-gray-50 py-16 px-4" ref={sectionRef}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-gradient-to-br from-red-600 to-red-800 rounded-2xl p-8 shadow-lg transform transition-all duration-500  hover:shadow-2xl">
            ...
            <p className={`text-white text-lg mb-8 leading-relaxed ${isVisible ? 'animate-fade-in-delay' : ''}`}>
              ...
              <span className="text-red-200 font-medium hover:text-white transition-colors duration-300">SERP keyword tracker</span> and{' '}
              <span className="text-red-200 font-medium hover:text-white transition-colors duration-300">search engine positioning tool</span>. 
            ...
            <div className="bg-white rounded-xl p-6 transform transition-all duration-300  hover:shadow-lg">
              ...
              <div className="h-48 relative">
                <svg className={`w-full h-full ${isVisible ? 'animate-grow' : ''}`} viewBox="0 0 400 200">
                  ...
                  <circle cx="0" cy="180" r="4" fill="#dc2626" className={isVisible ? 'animate-bounce' : ''}/>
                  <circle cx="50" cy="160" r="4" fill="#dc2626" className={isVisible ? 'animate-bounce' : ''} style={{animationDelay: isVisible ? '0.1s' : '0s'}}/>
                  <circle cx="100" cy="140" r="4" fill="#dc2626" className={isVisible ? 'animate-bounce' : ''} style={{animationDelay: isVisible ? '0.2s' : '0s'}}/>
                  <circle cx="150" cy="120" r="4" fill="#dc2626" className={isVisible ? 'animate-bounce' : ''} style={{animationDelay: isVisible ? '0.3s' : '0s'}}/>
                  <circle cx="200" cy="100" r="4" fill="#dc2626" className={isVisible ? 'animate-bounce' : ''} style={{animationDelay: isVisible ? '0.4s' : '0s'}}/>
                  <circle cx="250" cy="80" r="4" fill="#dc2626" className={isVisible ? 'animate-bounce' : ''} style={{animationDelay: isVisible ? '0.5s' : '0s'}}/>
                  <circle cx="300" cy="60" r="4" fill="#dc2626" className={isVisible ? 'animate-bounce' : ''} style={{animationDelay: isVisible ? '0.6s' : '0s'}}/>
                  <circle cx="350" cy="40" r="4" fill="#dc2626" className={isVisible ? 'animate-bounce' : ''} style={{animationDelay: isVisible ? '0.7s' : '0s'}}/>
                  <circle cx="400" cy="40" r="4" fill="#dc2626" className={isVisible ? 'animate-bounce' : ''} style={{animationDelay: isVisible ? '0.8s' : '0s'}}/>
                </svg>
              </div>
            </div>
          </div>
