          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-primary to-secondary p-6 rounded-xl shadow-lg border border-primary/20">
                ...
                <p className="text-white/80">Track rankings across all devices and screen sizes</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-secondary to-primary p-6 rounded-xl shadow-lg border border-secondary/20">
                ...
                <p className="text-white/80">Precise location-based ranking insights</p>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="bg-white p-8 rounded-2xl shadow-2xl border border-text-secondary/20">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-text-primary">Global Rankings</h3>
              ...
              <div className="space-y-6">
                {/* World Map Mockup */}
                <div className="relative h-48 bg-gradient-to-br from-background-light to-text-secondary/20 rounded-lg p-4">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <svg className="w-32 h-32 text-text-secondary/30" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>
                    </svg>
                  </div>
                  {/* Location Pins */}
                  <div className="absolute top-8 left-12 w-3 h-3 bg-primary rounded-full animate-pulse"></div>
                  <div className="absolute top-16 right-16 w-3 h-3 bg-secondary rounded-full animate-pulse"></div>
                  <div className="absolute bottom-12 left-20 w-3 h-3 bg-text-secondary rounded-full animate-pulse"></div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-primary/10 rounded-lg">
                    ...
                    <div className="text-sm text-text-secondary">Global</div>
                  </div>
                  <div className="text-center p-4 bg-secondary/10 rounded-lg">
                    <div className="text-2xl font-bold text-secondary">#1</div>
                    <div className="text-sm text-text-secondary">Local</div>
                  </div>
                  <div className="text-center p-4 bg-text-secondary/10 rounded-lg">
                    <div className="text-2xl font-bold text-text-secondary">#5</div>
                    <div className="text-sm text-text-secondary">Mobile</div>
                  </div>
                </div>
              </div>
            </div>
