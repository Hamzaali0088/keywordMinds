          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-4 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
                >
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">support@keywordminds.com</p>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-green-600 font-medium">4 hours</span>
                  </div>
                </div>
              </div>
                  ...
                  {socialLinks.map((social, index) => {
                    ...
                    return (
                      <a
                        ...
                        className={`w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors duration-200 ${social.color}`}
                      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-gray-600">We typically respond to all support emails within 24 hours, and most issues are resolved within 48 hours.</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-semibold text-gray-900 mb-2">Do you offer phone support?</h3>
                <p className="text-gray-600">Yes, we offer phone support Monday through Friday, 9AM-6PM EST for all paid plans.</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-semibold text-gray-900 mb-2">Can I schedule a demo call?</h3>
                <p className="text-gray-600">Absolutely! You can schedule a personalized demo by contacting our sales team or using the contact form above.</p>
              </div>
            </div>
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-semibold text-gray-900 mb-2">What information should I include in my support request?</h3>
                <p className="text-gray-600">Please include your account details, a clear description of the issue, and any relevant screenshots or error messages.</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-semibold text-gray-900 mb-2">Do you offer enterprise support?</h3>
                <p className="text-gray-600">Yes, enterprise customers receive priority support with dedicated account managers and faster response times.</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-semibold text-gray-900 mb-2">How can I get help with API integration?</h3>
                <p className="text-gray-600">Our technical team can help with API integration. Contact us with your specific requirements and we'll guide you through the process.</p>
              </div>
            </div>
          </div>
        </Container>
